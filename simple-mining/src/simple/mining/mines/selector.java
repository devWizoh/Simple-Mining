        ...
        if (s instanceof Player) {
            ...
            if (cmd.getName().equalsIgnoreCase("minas")) {
                ...
                if (p.hasPermission("mining.vip")) {
                    ...
                    inv.setItem(40, Create.add(Material.PACKED_ICE, "§6Mina VIP", new String[] { "§7", "§f §cMina bloqueada, você não", "§f §cpossui nenhum pacote §lVIP", "§7", "§f §cAdquira um acessando:", "§f §6bit.ly/redemagic-loja", "§7" }));
                }
                p.openInventory(inv);
            }
        }
